...
X_pred %>% select(dam2) %>% 
  saveRDS(file = "01 Modelo de area/PER/2017/Data/dam_pred.rds")
...
##########################################
# indicador_dam1 <- indicador_dam1[218,]
...
saveRDS(fit_mcmc2,
        "01 Modelo de area/PER/2017/Data/fit_rtanmultinomial_con_covariable2.Rds")

fit_mcmc2 <- readRDS("01 Modelo de area/PER/2017/Data/fit_rtanmultinomial_con_covariable.Rds")
