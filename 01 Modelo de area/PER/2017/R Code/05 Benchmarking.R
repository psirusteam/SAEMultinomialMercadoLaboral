...
infile <- paste0("01 Modelo de area/PER/2017/Data/estimaciones.rds") 
out_estimacion <- paste0("01 Modelo de area/PER/2017/Data/estimaciones_Bench.rds") 
...
jpeg(file = "01 Modelo de area/PER/2017/Output/Plot_Bench_gk.jpeg")
par(mfrow = c(1,3))
hist(gk_ocupado)
hist(gk_desocupado)
hist(gk_Inactivo)
