...
# encuesta <- read_dta("V:/DAT/BADEHOG_N/BC/MEX_2020N1.dta")
# dam2 <- read_dta("V:/DAT/BADEHOG_N/BG/mex20n1/mex20n1.dta")
# dam2 <- dam2 %>% transmute(
#   dam2 = str_pad(
#     string = ubica_geo,
#     width = 5,
...
# saveRDS(encuesta,'01 Modelo de area/MEX/2020/Data/encuesta_2018.Rds' )
encuesta <- readRDS('01 Modelo de area/MEX/2020/Data/encuesta_2018.Rds')
## 
...
#Guardar data----------------------------
saveRDS(indicador_dam,'01 Modelo de area/MEX/2020/Data/indicador_dam.Rds' )
