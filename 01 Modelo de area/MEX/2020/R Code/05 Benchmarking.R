...
encuesta <- readRDS("01 Modelo de area/MEX/2020/Data/encuesta_2020.Rds")
infile <- paste0("01 Modelo de area/MEX/2020/Data/estimaciones.rds") 
out_estimacion <- paste0("01 Modelo de area/MEX/2020/Data/estimaciones_Bench.rds") 
...
jpeg(file = "01 Modelo de area/MEX/2020/Output/Plot_Bench_gk.jpeg")
par(mfrow = c(1,3))
hist(gk_ocupado)
hist(gk_desocupado)
hist(gk_Inactivo)
