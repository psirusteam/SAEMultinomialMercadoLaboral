...
infile <- paste0("01 Modelo de area/COL/2018/Data/estimaciones_Bench.rds") 
outOcupado <-  paste0("01 Modelo de area/COL/2018/Output/Ocupados.png") 
outDesocupado <-  paste0("01 Modelo de area/COL/2018/Output/Desocupados.png") 
outInactivo <-  paste0("01 Modelo de area/COL/2018/Output/Inactivo.png") 
outMosaico <-  paste0("01 Modelo de area/COL/2018/Output/Mosaico.png") 
