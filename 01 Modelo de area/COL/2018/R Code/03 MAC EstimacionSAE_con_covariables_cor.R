...
indicador_dam <- readRDS('01 Modelo de area/COL/2018/Data/base_modelo.Rds')
...
fit_mcmc2 <- readRDS("01 Modelo de area/COL/2018/Data/fit_multinomial_cor.Rds")

## Valores estimados para beta

summary(fit_mcmc2)
summary(fit_mcmc2, pars = "beta")
