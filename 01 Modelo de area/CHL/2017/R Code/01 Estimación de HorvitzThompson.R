...
# encuesta <- read_dta("V:/DAT/BADEHOG_N/BC/CHL_2017N.dta")
# comuna <- read_dta("V:/DAT/BADEHOG_N/BG/chl17n/chl17n.dta")
# encuesta$comuna <- comuna$comuna
# saveRDS(encuesta,'01 Modelo de area/CHL/2017/Data/encuesta_2017.Rds' )
